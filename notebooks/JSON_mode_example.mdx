...
The group chat manager can perfrom some simple maths encoded into the
...
[here](https://ag2ai.github.io/ag2/blog/2023/12/29/AgentDescriptions/)
...
The strucutred and dependable nature of the output with the friendliness
