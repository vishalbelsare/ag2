...
Workflows](https://ag2ai.github.io/ag2/blog/2024/02/29/StateFlow).
...
> details in this
> [doc](https://ag2ai.github.io/ag2/docs/tutorial/tool-use)
...
A human user is trying to contact the aline custom serivce. Given a
request, we will also call `triage_agent` to determin whether it is lost
