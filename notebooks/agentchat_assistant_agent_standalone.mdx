...
To enable our assistant agent access to surf the web, we will use the
`BrowserUseTool` Tool for which we need to install the browser-use
...
arxiv_researcher, tasked with discovery of papers that allign with the
