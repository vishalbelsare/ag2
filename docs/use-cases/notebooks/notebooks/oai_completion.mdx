...
about this feature
[here](https://docs.ag2.ai/latest/docs/blog/2023/04/21/LLM-tuning-math).
...
```bash
pip install "ag2[openai,blendsearch]<0.2"
```
...
-   The
    [`config_list_openai_aoai`](https://docs.ag2.ai/latest/docs/api-reference/autogen/config_list_openai_aoai/#autogen.config_list_openai_aoai)
