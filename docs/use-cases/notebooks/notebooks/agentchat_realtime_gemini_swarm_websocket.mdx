---
custom_edit_url: https://github.com/ag2ai/ag2/edit/main/notebook/agentchat_realtime_gemini_swarm_websocket.ipynb
description: Swarm Ochestration
source_notebook: /notebook/agentchat_realtime_gemini_swarm_websocket.ipynb
tags:
- orchestration
- group chat
- swarm
...
<a href="https://colab.research.google.com/github/ag2ai/ag2/blob/main/notebook/agentchat_realtime_gemini_swarm_websocket.ipynb" class="colab-badge" target="_blank"><img noZoom src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" /></a>
<a href="https://github.com/ag2ai/ag2/blob/main/notebook/agentchat_realtime_gemini_swarm_websocket.ipynb" class="github-badge" target="_blank"><img noZoom src="https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github" alt="Open on GitHub" /></a>




AG2 supports **RealtimeAgent**, a powerful agent type that connects
seamlessly to Gemini [Multimodal Live
API](https://ai.google.dev/api/multimodal-live). With RealtimeAgent, you
can add voice interaction and listening capabilities to your swarms,
enabling dynamic and natural communication.
...
[Documentation](https://docs.ag2.ai/latest/docs/user-guide/basic-concepts/orchestration/swarm)
...
The
[`LLMConfig.from_json`](https://docs.ag2.ai/docs/api-reference/autogen/llm_config/LLMConfig)
...
6.  **Register a swarm**: Register a swarm to `RealtimeAgent` enabling
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/notebook/agentchat_realtime_gemini_swarm_websocket.ipynb" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
