...
If you want to get up and running with a swarm faster, we have implemented swarm within AG2, see [this notebook](https://docs.ag2.ai/docs/use-cases/notebooks/notebooks/agentchat_swarm).
</Tip>
</div>
...
Workflows](https://docs.ag2.ai/latest/docs/blog/2024/02/29/StateFlow).
...
> details in this
> [doc](https://docs.ag2.ai/docs/user-guide/basic-concepts/tools/index)
