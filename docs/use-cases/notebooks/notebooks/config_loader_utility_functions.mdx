...
configuration
docs](https://docs.ag2.ai/latest/docs/user-guide/basic-concepts/llm-configuration/llm-configuration/).
...
[`config_list_from_models`](https://docs.ag2.ai/latest/docs/api-reference/autogen/config_list_from_models/#autogen.config_list_from_models)
