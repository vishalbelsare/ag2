...
configuration
docs](https://docs.ag2.ai/docs/user-guide/basic-concepts/llm-configuration/llm-configuration/).
...
-   [`get_config_list`](../../../../api-reference/autogen/get_config_list):
    Generates configurations for API calls, primarily from provided API
    keys.
-   [`config_list_openai_aoai`](../../../../api-reference/autogen/config_list_openai_aoai):
    ...
    local files.
-   [`config_list_from_json`](../../../../api-reference/autogen/config_list_from_json):
    ...
    filtering configurations based on given criteria.
-   [`config_list_from_models`](../../../../api-reference/autogen/config_list_from_models):
    ...
    configuration.
-   [`config_list_from_dotenv`](../../../../api-reference/autogen/config_list_from_dotenv):
...
[`config_list_from_models`](https://ag2ai.github.io/ag2/latest/docs/api-reference/autogen/config_list_from_models/#autogen.config_list_from_models)
