...
Use](https://docs.ag2.ai/docs/user-guide/basic-concepts/tools/basics) -
[Nested
Chats](https://docs.ag2.ai/docs/user-guide/basic-concepts/orchestration/nested-chat)
...
chapter](https://docs.ag2.ai/docs/user-guide/basic-concepts/orchestration/nested-chat)
for more information.
