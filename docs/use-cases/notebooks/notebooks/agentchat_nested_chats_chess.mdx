...
Use](https://docs.ag2.ai/latest/docs/user-guide/basic-concepts/tools/basics/) -
[Nested
Chats](https://docs.ag2.ai/latest/docs/user-guide/basic-concepts/orchestration/nested-chat)
...
chapter](https://docs.ag2.ai/latest/docs/user-guide/basic-concepts/orchestration/nested-chat)
for more information.
