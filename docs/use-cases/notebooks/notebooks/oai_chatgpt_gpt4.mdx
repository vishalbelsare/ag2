...
feature
[here](https://docs.ag2.ai/docs/blog/2023-04-21-LLM-tuning-math/index).
...
Related link:
[Blogpost](https://docs.ag2.ai/blog/2023-04-21-LLM-tuning-math) based on
this experiment.
...
The
[`config_list_openai_aoai`](https://docs.ag2.ai/reference/autogen/config_list_openai_aoai#config-list-openai-aoai)
