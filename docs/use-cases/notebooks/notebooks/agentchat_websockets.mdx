...
[`IOStream`](https://docs.ag2.ai/latest/docs/api-reference/autogen/io/IOStream)
...
> ```bash
> pip install -U autogen[openai,websockets]
> ```
> or  
> ```bash
> pip install -U pyautogen[openai,websockets]
> ```
...
[`IOWebsockets`](https://docs.ag2.ai/latest/docs/api-reference/autogen/io/IOWebsockets/#autogen.io.IOWebsockets)
