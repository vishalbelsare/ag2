...
For more information, please refer to the [installation guide](https://docs.ag2.ai/docs/home/quick-start).
</Info>
</div>
...
# Refer to https://ag2.airt.ai/docs/reference/agentchat/contrib/retrieve_user_proxy_agent
# and https://ag2.airt.ai/docs/reference/agentchat/contrib/vectordb/couchbase
