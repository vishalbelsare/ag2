...
from autogen import AssistantAgent, LLMConfig, ThinkNode, UserProxyAgent
from autogen.agents.experimental import ReasoningAgent

api_key = os.environ.get("OPENAI_API_KEY")

llm_config = LLMConfig(config_list=[{"model": "gpt-4o-mini", "api_key": api_key}])
...
```python
grader_llm_config = LLMConfig(config_list=[{"model": "gpt-4o-mini", "api_key": api_key}])
