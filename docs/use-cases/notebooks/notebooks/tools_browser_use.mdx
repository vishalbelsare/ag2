---
custom_edit_url: https://github.com/ag2ai/ag2/edit/main/notebook/tools_browser_use.ipynb
description: Adding Browsing Capabilities to AG2
source_notebook: /notebook/tools_browser_use.ipynb
tags:
- tools
- browser-use
- webscraping
...
<a href="https://colab.research.google.com/github/ag2ai/ag2/blob/main/notebook/tools_browser_use.ipynb" class="colab-badge" target="_blank"><img noZoom src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab" /></a>
<a href="https://github.com/ag2ai/ag2/blob/main/notebook/tools_browser_use.ipynb" class="github-badge" target="_blank"><img noZoom src="https://img.shields.io/badge/Open%20on%20GitHub-grey?logo=github" alt="Open on GitHub" /></a>
...
For running the code in Jupyther, use `nest_asyncio` to allow nested
event loops.
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/notebook/tools_browser_use.ipynb" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
