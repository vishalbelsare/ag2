...
For more information on DocAgent, read about [DocAgent in our Reference
Agents](https://docs.ag2.ai/latest/docs/user-guide/reference-agents/docagent)
section.
...
The following documents can be ingested: - PDF - DOCX (DOCX, DOTX, DOCM,
DOTM) - XLSX - PPTX (PPTX, POTX, PPSX, PPTM, POTM, PPSM) - HTML -
ASCIIDOC (ADOC, ASCIIDOC, ASC) - MD (MD, MARKDOWN) - XML (XML, NXML) -
TXT - JSON - CSV - IMAGE (BMP, JPG, JPEG, PNG, TIFF, TIF)
