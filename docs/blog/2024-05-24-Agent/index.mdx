...
- Different [conversation patterns](/docs/tutorial/conversation-patterns) like [sequential chats](/docs/user-guide/advanced-concepts/conversation-patterns-deep-dive#sequential-chats), [group chat](/docs/user-guide/advanced-concepts/conversation-patterns-deep-dive#group-chat), [constrained group chat](/docs/user-guide/advanced-concepts/conversation-patterns-deep-dive#constrained-speaker-selection), [customized group chat](/docs/topics/groupchat/customized_speaker_selection), [nested chat](/docs/user-guide/advanced-concepts/conversation-patterns-deep-dive#nested-chats) and recursive composition of them.
...
- Integrating multiple [models](/docs/blog/2023-11-09-EcoAssistant/index), [APIs](/docs/topics/openai-assistant/gpt_assistant_agent), [modalities](/docs/blog/2023-11-06-LMM-Agent/index) and [memories](/docs/blog/2023-10-26-TeachableAgent/index).
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/_blogs/2024-05-24-Agent/index.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
