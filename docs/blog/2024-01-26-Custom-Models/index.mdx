...
<CardGroup cols={2}>
<Card href="https://github.com/olgavrou/">
    <div class="col card">
      <div class="img-placeholder">
        <img noZoom src="https://github.com/olgavrou.png" />
      </div>
      <div>
        <p class="name">Olga Vrousgou</p>
        <p>Senior Software Engineer at Microsoft Research</p>
      </div>
    </div>
</Card>
</CardGroup>
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/_blogs/2024-01-26-Custom-Models/index.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
