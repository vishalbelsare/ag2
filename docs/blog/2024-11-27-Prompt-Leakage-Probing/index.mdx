...
2. **ConversableAgents**
   - The system includes two [ConversableAgents](https://docs.ag2.ai/latest/docs/api-reference/autogen/ConversableAgent):
...
3. **UserProxyAgent**
   - A [UserProxyAgent](https://docs.ag2.ai/latest/docs/api-reference/autogen/UserProxyAgent/) acts as the intermediary for executing external functions, such as:
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/_blogs/2024-11-27-Prompt-Leakage-Probing/index.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
