...
See the official AutoGen Studio documentation [here](https://docs.ag2.ai/docs/autogen-studio/getting-started) for more details.

AutoGen Studio is open source [code here](https://github.com/ag2ai/build-with-ag2/blob/main/samples/apps/autogen-studio), and can be installed via pip. Give it a try!
...
To get started, you need access to a language model. You can get this set up by following the steps in the AutoGen documentation [here](https://docs.ag2.ai/docs/user-guide/advanced-concepts/llm-configuration-deep-dive#llm-configuration). Configure your environment with either `OPENAI_API_KEY` or `AZURE_OPENAI_API_KEY`.
...
2. **Install from Source**
   ...
   For Windows users, to build the frontend, you may need alternative commands provided in the [autogen studio readme](https://github.com/ag2ai/build-with-ag2/blob/main/samples/apps/autogen-studio).
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/_blogs/2023-12-01-AutoGenStudio/index.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
