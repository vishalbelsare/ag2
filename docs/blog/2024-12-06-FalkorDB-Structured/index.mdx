...
See the [Swarm documentation](https://docs.ag2.ai/docs/user-guide/advanced-concepts/swarm/nested-chat) for more information.
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/_blogs/2024-12-06-FalkorDB-Structured/index.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
