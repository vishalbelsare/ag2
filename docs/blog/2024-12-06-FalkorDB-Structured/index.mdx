...
See the [Trip Planner](https://docs.ag2.ai/notebooks/agentchat_swarm_graphrag_trip_planner) and [Structured Output](https://docs.ag2.ai/notebooks/agentchat_structured_outputs) notebooks to start using Structured Outputs.
...
* [Trip Planner Notebook Example Using GraphRag, Structured Output & Swarm](https://docs.ag2.ai/notebooks/agentchat_swarm_graphrag_trip_planner)
...
* [Structured Output Notebook Example](https://docs.ag2.ai/notebooks/agentchat_structured_outputs)
