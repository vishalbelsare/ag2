...
For a more in-depth example, [see this notebook](https://docs.ag2.ai/docs/use-cases/notebooks/notebooks/agentchat_swarm_graphrag_trip_planner/) where we create this Trip Planner workflow.
...
See the [Trip Planner](https://docs.ag2.ai/docs/use-cases/notebooks/notebooks/agentchat_swarm_graphrag_trip_planner) and [Structured Output](https://docs.ag2.ai/docs/use-cases/notebooks/notebooks/agentchat_structured_outputs) notebooks to start using Structured Outputs.
...
See the [Swarm documentation](https://docs.ag2.ai/docs/user-guide/advanced-concepts/enhanced-swarm#nested-chats) for more information.

## For Further Reading

* [Trip Planner Notebook Example Using GraphRag, Structured Output & Swarm](https://docs.ag2.ai/docs/use-cases/notebooks/notebooks/agentchat_swarm_graphrag_trip_planner)
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/_blogs/2024-12-06-FalkorDB-Structured/index.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
