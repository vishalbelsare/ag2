...
- **Provider parameters** - providers have parameters you can set such as temperature, maximum tokens, top-k, top-p, and safety. See each client class in AutoGen's [API Reference](/docs/api-reference/autogen/oai/gemini/GeminiClient) or [documentation](/docs/user-guide/models/google-gemini) for details.
...
The `[LLMConfig.from_json](https://docs.ag2.ai/docs/api-reference/autogen/llm_config/LLMConfig)` method loads a list of configurations from an environment variable or a json file.
