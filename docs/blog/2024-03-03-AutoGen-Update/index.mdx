...
- [Custom models and clients](/docs/blog/2024-01-26-Custom-Models/index) can be used as backends of an agent, such as Huggingface models and inference APIs.
...
- new features like [stateful code execution](/docs/user-guide/advanced-concepts/code-execution), [tool decorators](/docs/user-guide/basic-concepts/tools), [long context handling](/docs/use-cases/notebooks/notebooks/agentchat_transform_messages), [web agents](/docs/user-guide/reference-agents/websurferagent).
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/_blogs/2024-03-03-AutoGen-Update/index.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
