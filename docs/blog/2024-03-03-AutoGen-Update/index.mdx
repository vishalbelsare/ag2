...
- new features like [stateful code execution](/docs/tutorial/code-executors), [tool decorators](/docs/tutorial/tool-use), [long context handling](/notebooks/agentchat_transform_messages), [web agents](https://github.com/ag2ai/ag2/blob/main/notebook/agentchat_surfer.ipynb).
