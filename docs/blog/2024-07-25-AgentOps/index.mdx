...
<CardGroup cols={2}>
<Card href="https://github.com/areibman">
    <div class="col card">
      <div class="img-placeholder">
        <img noZoom src="https://github.com/areibman.png" />
      </div>
      <div>
        <p class="name">Alex Reibman</p>
        <p>Co-founder/CEO at AgentOps</p>
      </div>
    </div>
</Card>
<Card href="https://github.com/bboynton97">
    <div class="col card">
      <div class="img-placeholder">
        <img noZoom src="https://github.com/bboynton97.png" />
      </div>
      <div>
        <p class="name">Braelyn Boynton</p>
        <p>AI Engineer at AgentOps</p>
      </div>
    </div>
</Card>
</CardGroup>
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/_blogs/2024-07-25-AgentOps/index.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
