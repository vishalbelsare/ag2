...
Refer to the [doc](https://docs.ag2.ai/docs/reference/agentchat/contrib/retrieve_user_proxy_agent)
...
llm_config = LLMConfig(config_list=config_list, timeout=60, temperature=0)
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/_blogs/2023-10-18-RetrieveChat/index.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
