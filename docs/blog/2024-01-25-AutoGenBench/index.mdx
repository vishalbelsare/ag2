...
- See the [AutoGenBench README](https://github.com/ag2ai/build-with-ag2/blob/main/samples/tools/autogenbench/README.md) for information on installation and running benchmarks.
- See the [AutoGenBench CONTRIBUTING guide](https://github.com/ag2ai/build-with-ag2/blob/main/samples/tools/autogenbench/CONTRIBUTING.md) for information on developing or contributing benchmark datasets.
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/_blogs/2024-01-25-AutoGenBench/index.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
