...
<CardGroup cols={2}>
<Card href="https://github.com/joshkyh/">
    <div class="col card">
      <div class="img-placeholder">
        <img noZoom src="https://github.com/joshkyh.png" />
      </div>
      <div>
        <p class="name">Joshua Kim</p>
        <p>AI Freelancer at SpectData</p>
      </div>
    </div>
</Card>
<Card href="https://github.com/freedeaths/">
    <div class="col card">
      <div class="img-placeholder">
        <img noZoom src="https://github.com/freedeaths.png" />
      </div>
      <div>
        <p class="name">Yishen Sun</p>
        <p>Data Scientist at PingCAP LAB</p>
      </div>
    </div>
</Card>
</CardGroup>
