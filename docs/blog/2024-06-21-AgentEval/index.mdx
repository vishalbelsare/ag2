...
<CardGroup cols={2}>
<Card href="https://github.com/jluey1">
    <div class="col card">
      <div class="img-placeholder">
        <img noZoom src="https://github.com/jluey1.png" />
      </div>
      <div>
        <p class="name">James Woffinden-Luey</p>
        <p>Senior Research Engineer at Microsoft Research</p>
      </div>
    </div>
</Card>
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/_blogs/2024-06-21-AgentEval/index.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
