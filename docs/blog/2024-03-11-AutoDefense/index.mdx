...
<CardGroup cols={2}>
<Card href="https://xhmy.github.io/">
    <div class="col card">
      <div class="img-placeholder">
        <img noZoom src="https://xhmy.github.io/assets/img/photo.jpg" />
      </div>
      <div>
        <p class="name">Yifan Zeng</p>
        <p>PhD student at Oregon State University</p>
      </div>
    </div>
</Card>
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/_blogs/2024-03-11-AutoDefense/index.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
