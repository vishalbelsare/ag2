...
The valid aliases of AG2 package at PyPI are `ag2`, `autogen`, and `pyautogen`.
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/faq/FAQ.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
