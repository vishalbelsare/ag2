...
AG2 supports human intervention.

In AG2’s `ConversableAgent`, the human-in-the-loop component sits in
...
Currently AG2 supports three modes for human input. The mode is
