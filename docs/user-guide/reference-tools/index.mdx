...
[`PerplexitySearchTool`](/docs/api-reference/autogen/tools/experimental/PerplexitySearchTool) allows your agents to perform real-time web search and question-answering using Perplexity AI-powered search engine.
