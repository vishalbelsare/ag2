...
- [`WikipediaQueryRunTool`](/docs/api-reference/autogen/tools/experimental/WikipediaQueryRunTool)
  Enables the agent to perform Wikipedia searches and retrieve relevant summaries.

- [`WikipediaPageLoadTool`](/docs/api-reference/autogen/tools/experimental/WikipediaPageLoadTool)
