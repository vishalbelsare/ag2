...
See this [notebook](/docs/use-cases/notebooks/notebooks/tools_commsplatforms) for examples of using all the the communication tools, and guidance on establishing the relevant authentication tokens and IDs.
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/user-guide/reference-agents/communication-agents.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
