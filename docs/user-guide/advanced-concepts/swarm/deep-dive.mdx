...
(*Caution*: The notes below only apply to functions that will used in swarm chats with [`initiate_swarm_chat`](/docs/api-reference/autogen/initiate_swarm_chat)//docs/api-reference/autogen/a_initiate_swarm_chat)
...
The syntax for creating an using [`OnContextCondition`](/docs/api-reference/autogen/OnContextCondition) is very similar to [`OnCondition`](/docs/api-reference/autogen/OnCondition), with the exception being the condition is a [`ContextExpression`](/docs/api-reference/autogen/ContextExpression).
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/user-guide/advanced-concepts/swarm/deep-dive.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
