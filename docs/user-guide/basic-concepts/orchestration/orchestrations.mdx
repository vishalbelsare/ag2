...
4. **Group chat**: A chat with more than two agents with options on how agents are selected. See [GroupChat Overview](/docs/user-guide/advanced-concepts/groupchat/groupchat) for further details.
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/user-guide/basic-concepts/orchestration/orchestrations.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
