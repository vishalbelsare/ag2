...
```bash
pip install ag2["openai","cerebras"]
```

<Tip>
If you have been using `autogen` or `pyautogen`, all you need to do is upgrade it using:
```bash
pip install -U autogen[openai,"cerebras"]
```
or
```bash
pip install -U pyautogen[openai,"cerebras"]
```
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/user-guide/models/cerebras.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
