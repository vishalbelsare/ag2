...
| `select_speaker_auto_llm_config` | **Type:** [LLMConfig](/docs/api-reference/autogen/llm_config/LLMConfig) \| dict[str, typing.Any] \| Literal[False] \| None<br/><br/>**Default:** None |
...
| Name | Description |
|--|--|
| `last_speaker` | The previous speaker in the group chat<br/><br/>**Type:** [Agent](/docs/api-reference/autogen/Agent) |
| `selector` | The ConversableAgent that initiated the speaker selection<br/><br/>**Type:** [ConversableAgent](/docs/api-reference/autogen/ConversableAgent) |
| `messages` | Current chat messages<br/><br/>**Type:** list[dict[str, typing.Any]] \| None |
| `agents` | Valid list of agents for speaker selection<br/><br/>**Type:** list[[Agent](/docs/api-reference/autogen/Agent)] \| None |

<b>Returns:</b>
| Type | Description |
|--|--|
| [Agent](/docs/api-reference/autogen/Agent) | A counter for mentioned agents. |
