...
```
    ...
    structural subtyping (static duck-typing), for example:: <br/>    class C: <br/>        def meth(self) -> int: <br/>            return 0
    ...
    only the presence of given attributes, ignoring their type signatures.<br/>Protocol classes can be generic, they are defined as:: <br/>    class GenProto(Protocol[T]): <br/>        def meth(self) -> T: <br/>            ...
