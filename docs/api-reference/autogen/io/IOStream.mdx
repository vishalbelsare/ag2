...
| Name | Description |
|--|--|
| `stream` | The input/output stream to set as the default.<br/><br/>**Type:** ForwardRef('[IOStream](/docs/api-reference/autogen/io/IOStream)') \| None |
...
| Name | Description |
|--|--|
| `stream` | The input/output stream to set as the default.<br/><br/>**Type:** [IOStream](/docs/api-reference/autogen/io/IOStream) |
...
| Name | Description |
|--|--|
| `message` | BaseEvent from autogen.messages.base_message<br/><br/>**Type:** [BaseEvent](/docs/api-reference/autogen/events/BaseEvent) |
