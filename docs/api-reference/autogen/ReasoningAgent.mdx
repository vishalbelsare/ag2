...
| `sender` | Agent sending the messages<br/><br/>**Type:** [Agent](/docs/api-reference/autogen/Agent) |
...
| Name | Description |
|--|--|
| `node` | Node containing the reasoning trajectory to evaluate<br/><br/>**Type:** [ThinkNode](/docs/api-reference/autogen/ThinkNode) |
