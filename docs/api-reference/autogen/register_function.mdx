...
register_function(
    f: Callable[..., Any],
    *,
    caller: autogen.agentchat.conversable_agent.ConversableAgent,
    executor: autogen.agentchat.conversable_agent.ConversableAgent,
    name: str | None = None,
    description: str
) -> None
```
...
| `caller` | the agent calling the function, typically an instance of ConversableAgent.<br/><br/>**Type:** `autogen.agentchat.conversable_agent.ConversableAgent` |
| `executor` | the agent executing the function, typically an instance of UserProxy.<br/><br/>**Type:** `autogen.agentchat.conversable_agent.ConversableAgent` |
