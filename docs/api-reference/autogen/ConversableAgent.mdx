...
ConversableAgent(
    ...
    context_variables: ForwardRef('ContextVariables') | None = None,
...
| `context_variables` | **Type:** ForwardRef('ContextVariables') \| None<br/><br/>**Default:** None |
...
| `handoffs` | **Type:** [Handoffs](/docs/api-reference/autogen/agentchat/group/handoffs/Handoffs) \| None<br/><br/>**Default:** None |
