...
ConversableAgent(
    ...
    function_map: dict[str, typing.Callable[..., typing.Any]] | None = None,
    code_execution_config: dict[str, typing.Any] | Literal[False] = False,
    llm_config: dict[str, typing.Any] | Literal[False] | None = None,
    default_auto_reply: dict[str, typing.Any] | str = '',
    description: str | None = None,
    chat_messages: dict[autogen.agentchat.agent.Agent, list[dict[str, typing.Any]]] | None = None,
    silent: bool | None = None,
    context_variables: dict[str, typing.Any] | None = None,
    functions: list[typing.Callable[..., typing.Any]] | Callable[..., Any] = None,
...
| `chat_messages` | **Type:** `dict[autogen.agentchat.agent.Agent, list[dict[str, typing.Any]]] \| None`<br/><br/>**Default:** None |
...
a_generate_function_call_reply(
    ...
    sender: autogen.agentchat.agent.Agent | None = None,
    config: Any | None = None
) -> tuple[bool, dict[str, typing.Any] | None]
```
...
a_generate_init_message(
    self,
    message: str | dict[str, typing.Any] | None,
    **kwargs: Any
...
a_generate_oai_reply(
    ...
    sender: autogen.agentchat.agent.Agent | None = None,
    config: Any | None = None
) -> tuple[bool, str | dict[str, typing.Any] | None]
```
...
a_initiate_chat(
    ...
    summary_args: dict[str, typing.Any] | None = {},
...
generate_code_execution_reply(
    ...
    messages: list[dict[str, typing.Any]] | None = None,
    sender: autogen.agentchat.agent.Agent | None = None,
    config: dict[str, typing.Any] | Literal[False] | None = None
) -> 
```
...
initiate_chat(
    ...
    summary_method: str | Callable[..., Any] | None = 'last_msg',
    summary_args: dict[str, typing.Any] | None = {},
    message: dict[str, typing.Any] | str | Callable[..., Any] | None = None,
    **kwargs: Any
) -> autogen.agentchat.chat.ChatResult
```
...
```python
last_message(self, agent: autogen.agentchat.agent.Agent | None = None) -> dict[str, typing.Any] | None
```
...
```python
process_all_messages_before_reply(self, messages: list[dict[str, typing.Any]]) -> list[dict[str, typing.Any]]
```
...
```python
process_last_received_message(self, messages: list[dict[str, typing.Any]]) -> list[dict[str, typing.Any]]
```
...
```python
register_function(self, function_map: dict[str, typing.Callable[..., typing.Any]]) -> 
```
...
```python
update_agent_state_before_reply(self, messages: list[dict[str, typing.Any]]) -> None
```
...
update_function_signature(
    self,
    func_sig: dict[str, typing.Any] | str,
    is_remove: None
) -> 
```
...
update_tool_signature(
    self,
    tool_sig: dict[str, typing.Any] | str,
    is_remove: bool
) -> 
```
