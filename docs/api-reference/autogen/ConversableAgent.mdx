...
| `functions` | **Type:** list[typing.Callable[..., typing.Any]] \| Callable[..., Any]<br/><br/>**Default:** None |
| `update_agent_state_before_reply` | **Type:** list[Callable \| [UpdateSystemMessage](/docs/api-reference/autogen/UpdateSystemMessage)] \| Callable \| [UpdateSystemMessage](/docs/api-reference/autogen/UpdateSystemMessage) \| None<br/><br/>**Default:** None |
...
| Name | Description |
|--|--|
| `recipient` | **Type:** [ConversableAgent](/docs/api-reference/autogen/ConversableAgent) |
...
| Name | Description |
|--|--|
| `recipient` | the recipient agent.<br/><br/>**Type:** [ConversableAgent](/docs/api-reference/autogen/ConversableAgent) |
