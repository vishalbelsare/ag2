...
ConversableAgent(
    ...
    llm_config_filter: LLMConfigFilter | dict[str, Any] | None = None,
...
| `llm_config_filter` | **Type:** autogen.llm_config.LLMConfigFilter \| dict[str, typing.Any] \| None<br/><br/>**Default:** None |
