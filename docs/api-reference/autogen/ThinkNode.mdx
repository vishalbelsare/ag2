...
|--|--|
| `content` | **Type:** `str` |
| `parent` | **Type:** `ForwardRef('ThinkNode') \| None`<br/><br/>**Default:** None |
...
```
    ...
    Convert ThinkNode to dictionary representation.<br/>Returns: <br/>    Dict: Dictionary containing all node attributes and recursive children
