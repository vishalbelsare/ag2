---
sidebarTitle: DiscordRetrieveTool
title: autogen.tools.experimental.DiscordRetrieveTool
---
<h2 id="autogen.tools.experimental.DiscordRetrieveTool" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">DiscordRetrieveTool</span>
</h2>

```python
DiscordRetrieveTool(**kwargs)
```

    Retrieves messages from a Discord channel.<br/>Initialize the DiscordRetrieveTool.<br/>
