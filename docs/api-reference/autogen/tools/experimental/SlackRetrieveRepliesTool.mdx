---
sidebarTitle: SlackRetrieveRepliesTool
title: autogen.tools.experimental.SlackRetrieveRepliesTool
---
<h2 id="autogen.tools.experimental.SlackRetrieveRepliesTool" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">SlackRetrieveRepliesTool</span>
</h2>
...
```
    ...
    Retrieves replies to a specific Slack message from both threads and the channel.<br/>Initialize the SlackRetrieveRepliesTool.<br/>
