---
sidebarTitle: SlackSendTool
title: autogen.tools.experimental.SlackSendTool
---
<h2 id="autogen.tools.experimental.SlackSendTool" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">SlackSendTool</span>
</h2>

```python
SlackSendTool(**kwargs)
```

    Sends a message to a Slack channel.<br/>Initialize the SlackSendTool.<br/>
