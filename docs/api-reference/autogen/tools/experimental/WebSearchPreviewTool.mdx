---
sidebarTitle: WebSearchPreviewTool
title: autogen.tools.experimental.WebSearchPreviewTool
---
<h2 id="autogen.tools.experimental.WebSearchPreviewTool" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">WebSearchPreviewTool</span>
</h2>
...
```
    ...
    WebSearchPreviewTool is a tool that uses OpenAI's web_search_preview tool to perform a search.<br/>Initialize the WebSearchPreviewTool.<br/>

<b>Parameters:</b>
| Name | Description |
|--|--|
| `llm_config` | **Type:** [LLMConfig](/docs/api-reference/autogen/llm_config/LLMConfig) \| dict[str, typing.Any] |
| `search_context_size` | **Type:** Literal['low', 'medium', 'high']<br/><br/>**Default:** 'medium' |
| `user_location` | **Type:** dict[str, str] \| None<br/><br/>**Default:** None |
| `instructions` | **Type:** str \| None<br/><br/>**Default:** None |
| `text_format` | **Type:** Type[pydantic.main.BaseModel] \| None<br/><br/>**Default:** None |
