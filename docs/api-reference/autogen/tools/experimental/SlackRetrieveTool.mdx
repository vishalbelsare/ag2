---
sidebarTitle: SlackRetrieveTool
title: autogen.tools.experimental.SlackRetrieveTool
---
<h2 id="autogen.tools.experimental.SlackRetrieveTool" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">SlackRetrieveTool</span>
</h2>

```python
SlackRetrieveTool(**kwargs)
```

    Retrieves messages from a Slack channel.<br/>Initialize the SlackRetrieveTool.<br/>
