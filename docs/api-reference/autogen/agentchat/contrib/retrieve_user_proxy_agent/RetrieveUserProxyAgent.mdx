...
| `retrieve_config` | **Type:** dict[str, typing.Any] \| None<br/><br/>**Default:** None |
| `**kwargs` | **Type:** Any |
...
```
    ...
    Generate an initial message with the given context for the RetrieveUserProxyAgent.<br/>
...
```
    ...
    Retrieve docs based on the given problem and assign the results to the class property `_results`.<br/>The retrieved docs should be type of `QueryResults` which is a list of tuples containing the document and
    the distance.<br/>
