...
```
    ...
    (Experimental) Retrieve Assistant agent, designed to solve a task with LLM.<br/>RetrieveAssistantAgent is a subclass of AssistantAgent configured with a default system message.<br/>The default system message is designed to solve a task with LLM,
