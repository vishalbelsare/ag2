...
build(
    self,
    building_task: str,
    default_llm_config: dict[str, typing.Any],
    coding: bool | None = None,
    code_execution_config: dict[str, typing.Any] | None = None,
    use_oai_assistant: bool | None = False,
    user_proxy: autogen.agentchat.conversable_agent.ConversableAgent | None = None,
    max_agents: int | None = None,
    **kwargs: Any
) -> tuple[list[autogen.agentchat.conversable_agent.ConversableAgent], dict[str, typing.Any]]
```
...
| Type | Description |
|--|--|
| `tuple[list[autogen.agentchat.conversable_agent.ConversableAgent], dict[str, typing.Any]]` | agent_list: a list of agents. cached_configs: cached configs. |
