...
CaptainUserProxyAgent(
    ...
    default_auto_reply: str | dict[str, Any] | None = "I'm a proxy and I can only execute your tool or end the conversation. If you think the problem is solved, please reply me only with 'TERMINATE'.",
...
|--|--|
| `name` | **Type:** str |
| `nested_config` | **Type:** dict[str, typing.Any] |
...
| `code_execution_config` | **Type:** dict[str, typing.Any] \| Literal[False] \| None<br/><br/>**Default:** None |
| `default_auto_reply` | **Type:** str \| dict[str, typing.Any] \| None<br/><br/>**Default:** "I'm a proxy and I can only execute your tool or end the conversation. If you think the problem is solved, please reply me only with 'TERMINATE'." |
