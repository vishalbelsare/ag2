...
| `llm_config` | llm inference configuration.<br/><br/>Please refer to [OpenAIWrapper.create](/docs/api-reference/autogen/OpenAIWrapper#create) for available options.<br/><br/>Default to false, which disables llm-based auto reply.<br/><br/>**Type:** `dict \| Literal[False] \| None`<br/><br/>**Default:** False |
