---
sidebarTitle: MultimodalConversableAgent
title: autogen.agentchat.contrib.multimodal_conversable_agent.MultimodalConversableAgent
---
...
```python
update_system_message(self, system_message: dict[str, Any] | list[str] | str) -> 
```
...
| Name | Description |
|--|--|
| `system_message` | system message for the OpenAIWrapper inference.<br/><br/>**Type:** dict[str, typing.Any] \| list[str] \| str |
