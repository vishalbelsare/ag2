...
```
    ...
    Base class for optimizing AutoGen agents. Specifically, it is used to optimize the functions used in the agent.<br/>More information could be found in the following paper: https://arxiv.org/abs/2402.11359.<br/>(These APIs are experimental and may change in the future.)
...
record_one_conversation(
    self,
    conversation_history: list[dict[str, typing.Any]],
