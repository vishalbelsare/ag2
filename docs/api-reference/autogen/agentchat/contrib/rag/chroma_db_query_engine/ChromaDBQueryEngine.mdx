...
title: autogen.agentchat.contrib.rag.chroma_db_query_engine.ChromaDBQueryEngine
---
<h2 id="autogen.agentchat.contrib.rag.chroma_db_query_engine.ChromaDBQueryEngine" class="doc doc-heading">
