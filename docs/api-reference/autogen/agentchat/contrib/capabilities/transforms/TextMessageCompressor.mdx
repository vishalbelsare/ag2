...
| Name | Description |
|--|--|
| `text_compressor` | **Type:** `autogen.agentchat.contrib.capabilities.text_compressors.TextCompressor \| None`<br/><br/>**Default:** None |
...
```python
apply_transform(self, messages: list[dict[str, typing.Any]]) -> list[dict[str, typing.Any]]
```
...
get_logs(
    self,
    pre_transform_messages: list[dict[str, typing.Any]],
    post_transform_messages: list[dict[str, typing.Any]]
) -> tuple[str, bool]
```
