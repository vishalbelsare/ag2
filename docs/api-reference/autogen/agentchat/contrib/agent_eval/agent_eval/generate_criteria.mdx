...
| Name | Description |
|--|--|
| `llm_config` | llm inference configuration.<br/><br/>**Type:** [LLMConfig](/docs/api-reference/autogen/llm_config/LLMConfig) \| dict[str, typing.Any] \| Literal[False] \| None<br/><br/>**Default:** None |
