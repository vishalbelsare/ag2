...
|--|--|
| `name` | **Type:** str |
| `chat_manager` | **Type:** [GroupChatManager](/docs/api-reference/autogen/GroupChatManager) |
| `response_preparer` | **Type:** str \| Callable[..., Any] \| None<br/><br/>**Default:** None |
...
```python
update_chat_manager(self, chat_manager: GroupChatManager | None) -> 
```
...
| Name | Description |
|--|--|
| `chat_manager` | the group chat manager<br/><br/>**Type:** [GroupChatManager](/docs/api-reference/autogen/GroupChatManager) \| None |
