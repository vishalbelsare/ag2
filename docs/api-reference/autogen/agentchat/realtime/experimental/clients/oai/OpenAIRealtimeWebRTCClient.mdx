...
```
    ...
    Read messages from the OpenAI Realtime API.<br/>Again, in case of WebRTC, we do not read OpenAI messages directly since we
...
```python
session_init_data(self) -> list[dict[str, typing.Any]]
```
