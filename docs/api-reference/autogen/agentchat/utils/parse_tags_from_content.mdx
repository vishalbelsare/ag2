...
```python
parse_tags_from_content(tag: str, content: list[dict[str, typing.Any]] | str) -> list[dict[str, dict[str, str]]]
```
...
| `content` | The message content to parse.<br/><br/>Can be a string or a list of content items.<br/><br/>**Type:** `list[dict[str, typing.Any]] \| str` |
