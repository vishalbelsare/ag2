...
title: autogen.agentchat.group.targets.transition_target.TerminateTarget
---
<h2 id="autogen.agentchat.group.targets.transition_target.TerminateTarget" class="doc doc-heading">
