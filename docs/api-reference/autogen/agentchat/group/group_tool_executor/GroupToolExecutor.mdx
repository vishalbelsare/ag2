---
sidebarTitle: GroupToolExecutor
title: autogen.agentchat.group.group_tool_executor.GroupToolExecutor
---
<h2 id="autogen.agentchat.group.group_tool_executor.GroupToolExecutor" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">GroupToolExecutor</span>
</h2>
...
```python
get_next_target(self) -> TransitionTarget
```
...
| `context_variables` | **Type:** [ContextVariables](/docs/api-reference/autogen/agentchat/group/context_variables/ContextVariables) |
...
```python
set_next_target(self, next_target: TransitionTarget) -> None
```
...
| Name | Description |
|--|--|
| `next_target` | **Type:** [TransitionTarget](/docs/api-reference/autogen/agentchat/group/targets/transition_target/TransitionTarget) |
