---
sidebarTitle: RoundRobinPattern
title: autogen.agentchat.group.patterns.round_robin.RoundRobinPattern
---
<h2 id="autogen.agentchat.group.patterns.round_robin.RoundRobinPattern" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">RoundRobinPattern</span>
</h2>
...
```
    ...
    RoundRobinPattern implements a round robin with handoffs between agents.<br/>Initialize the pattern with the required components.<br/>
