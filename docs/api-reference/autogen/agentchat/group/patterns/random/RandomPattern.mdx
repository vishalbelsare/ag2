---
sidebarTitle: RandomPattern
title: autogen.agentchat.group.patterns.random.RandomPattern
---
<h2 id="autogen.agentchat.group.patterns.random.RandomPattern" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">RandomPattern</span>
</h2>
...
```
    ...
    RandomPattern implements a random agent selection process.<br/>Initialize the pattern with the required components.<br/>
