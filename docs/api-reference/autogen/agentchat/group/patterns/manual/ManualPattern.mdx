---
sidebarTitle: ManualPattern
title: autogen.agentchat.group.patterns.manual.ManualPattern
---
<h2 id="autogen.agentchat.group.patterns.manual.ManualPattern" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">ManualPattern</span>
</h2>
...
```
    ...
    ManualPattern will ask the user to nominate the next agent to speak at each turn.<br/>Initialize the ManualPattern.<br/>The after_work is always set to ask_user, which will prompt the user for the next agent
