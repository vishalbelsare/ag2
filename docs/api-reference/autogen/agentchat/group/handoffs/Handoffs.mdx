...
| Name | Description |
|--|--|
| `condition` | The condition to add (OnContextCondition or OnCondition)<br/><br/>**Type:** [OnContextCondition](/docs/api-reference/autogen/OnContextCondition) \| [OnCondition](/docs/api-reference/autogen/OnCondition) |
...
| Name | Description |
|--|--|
| `condition` | The OnContextCondition to add<br/><br/>**Type:** [OnContextCondition](/docs/api-reference/autogen/OnContextCondition) |
...
| Name | Description |
|--|--|
| `conditions` | List of OnContextConditions to add<br/><br/>**Type:** list[[OnContextCondition](/docs/api-reference/autogen/OnContextCondition)] |
...
| Name | Description |
|--|--|
| `conditions` | List of conditions to add<br/><br/>**Type:** list[[OnContextCondition](/docs/api-reference/autogen/OnContextCondition) \| [OnCondition](/docs/api-reference/autogen/OnCondition)] |
...
| Type | Description |
|--|--|
| list[[OnContextCondition](/docs/api-reference/autogen/OnContextCondition)] | List of conditions of the specified type, or None if none exist |
...
| Type | Description |
|--|--|
| list[[OnContextCondition](/docs/api-reference/autogen/OnContextCondition)] | List of context conditions that require wrapping |
