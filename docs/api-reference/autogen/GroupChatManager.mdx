...
| Type | Description |
|--|--|
| tuple[[ConversableAgent](/docs/api-reference/autogen/ConversableAgent), dict[str, typing.Any]] | - Tuple[ConversableAgent, Dict]: A tuple containing the last agent who spoke and their message |
