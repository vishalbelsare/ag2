...
| Name | Description |
|--|--|
| `messages` | The content of the previous chat's messages, either as a Json string or a list of message dictionaries.<br/><br/>**Type:** list[dict[str, typing.Any]] \| str |
| `remove_termination_string` | Remove the termination string from the last message to prevent immediate termination If a string is provided, this string will be removed from last message.<br/><br/>If a function is provided, the last message will be passed to this function, and the function returns the string after processing.<br/><br/>**Type:** str \| Callable[[str], str] \| None<br/><br/>**Default:** None |
...
| Type | Description |
|--|--|
| tuple[[ConversableAgent](/docs/api-reference/autogen/ConversableAgent), dict[str, typing.Any]] | A tuple containing the last agent who spoke and their message |
...
| `messages` | **Type:** list[dict[str, typing.Any]] \| None<br/><br/>**Default:** None |
| `sender` | **Type:** [Agent](/docs/api-reference/autogen/Agent) \| None<br/><br/>**Default:** None |
| `config` | **Type:** [GroupChat](/docs/api-reference/autogen/GroupChat) \| None<br/><br/>**Default:** None |
...
| `groupchat` | GroupChat object.<br/><br/>**Type:** [GroupChat](/docs/api-reference/autogen/GroupChat) |
...
```python
messages_from_string(self, message_string: str) -> list[dict[str, Any]]
```
...
| Name | Description |
|--|--|
| `message_string` | Json string, the saved state<br/><br/>**Type:** str |

<b>Returns:</b>
| Type | Description |
|--|--|
| list[dict[str, typing.Any]] | A list of messages |
...
```python
messages_to_string(self, messages: list[dict[str, Any]]) -> str
```
...
| Name | Description |
|--|--|
| `messages` | set of messages to convert to a string<br/><br/>**Type:** list[dict[str, typing.Any]] |
...
|--|--|
| `messages` | The content of the previous chat's messages, either as a Json string or a list of message dictionaries.<br/><br/>**Type:** list[dict[str, typing.Any]] \| str |
| `remove_termination_string` | Remove the termination string from the last message to prevent immediate termination If a string is provided, this string will be removed from last message.<br/><br/>If a function is provided, the last message will be passed to this function.<br/><br/>**Type:** str \| Callable[[str], str] \| None<br/><br/>**Default:** None |
| `silent` | (Experimental) whether to print the messages for this conversation.<br/><br/>Default is False.<br/><br/>**Type:** bool \| None<br/><br/>**Default:** False |
