...
| `fallback` | A function to call when an unknown value is encountered.<br/><br/>If not provided, a [`PydanticSerializationError`][pydantic_core.PydanticSerializationError] error is raised.<br/><br/>**Type:** Callable[[Any], Any] \| None<br/><br/>**Default:** None |
