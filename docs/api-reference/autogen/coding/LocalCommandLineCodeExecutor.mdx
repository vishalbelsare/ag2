...
| `functions` | **Type:** `list[autogen.coding.func_with_reqs.FunctionWithRequirements[typing.Any, ~A] \| Callable[..., Any] \| autogen.coding.func_with_reqs.FunctionWithRequirementsStr]`<br/><br/>**Default:** [] |
