---
sidebarTitle: GroqLLMConfigEntry
title: autogen.oai.groq.GroqLLMConfigEntry
---
<h2 id="autogen.oai.groq.GroqLLMConfigEntry" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">GroqLLMConfigEntry</span>
</h2>

```python
GroqLLMConfigEntry(**data: Any)
```
