---
sidebarTitle: CohereLLMConfigEntry
title: autogen.oai.cohere.CohereLLMConfigEntry
---
<h2 id="autogen.oai.cohere.CohereLLMConfigEntry" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">CohereLLMConfigEntry</span>
</h2>

```python
CohereLLMConfigEntry(**data: Any)
```
