---
sidebarTitle: AzureOpenAILLMConfigEntry
title: autogen.oai.client.AzureOpenAILLMConfigEntry
---
<h2 id="autogen.oai.client.AzureOpenAILLMConfigEntry" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">AzureOpenAILLMConfigEntry</span>
</h2>

```python
AzureOpenAILLMConfigEntry(**data: Any)
```
