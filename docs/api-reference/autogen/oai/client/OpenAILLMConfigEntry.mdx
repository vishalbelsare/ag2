---
sidebarTitle: OpenAILLMConfigEntry
title: autogen.oai.client.OpenAILLMConfigEntry
---
<h2 id="autogen.oai.client.OpenAILLMConfigEntry" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">OpenAILLMConfigEntry</span>
</h2>

```python
OpenAILLMConfigEntry(**data: Any)
```
