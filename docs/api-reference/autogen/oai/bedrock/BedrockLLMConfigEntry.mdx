---
sidebarTitle: BedrockLLMConfigEntry
title: autogen.oai.bedrock.BedrockLLMConfigEntry
---
<h2 id="autogen.oai.bedrock.BedrockLLMConfigEntry" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">BedrockLLMConfigEntry</span>
</h2>

```python
BedrockLLMConfigEntry(**data: Any)
```
...
```python
serialize_aws_secrets(self, v: SecretStr) -> str
```
