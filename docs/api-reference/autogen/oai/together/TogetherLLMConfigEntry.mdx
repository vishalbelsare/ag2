---
sidebarTitle: TogetherLLMConfigEntry
title: autogen.oai.together.TogetherLLMConfigEntry
---
<h2 id="autogen.oai.together.TogetherLLMConfigEntry" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">TogetherLLMConfigEntry</span>
</h2>

```python
TogetherLLMConfigEntry(**data: Any)
```
