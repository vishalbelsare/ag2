---
sidebarTitle: TimeReplyAgent
title: autogen.agents.contrib.TimeReplyAgent
---
<h2 id="autogen.agents.contrib.TimeReplyAgent" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">TimeReplyAgent</span>
</h2>
...
```
    ...
    A simple agent that returns the current time.<br/>Use it is as a reference for creating new agents with a reply-based approach (as opposed to tool-based).<br/>This agent will return the date and time whenever it needs to reply.<br/>Initialize the TimeReplyAgent.<br/>

<b>Parameters:</b>
| Name | Description |
|--|--|
| `date_time_format` | **Type:** str<br/><br/>**Default:** '%Y-%m-%d %H |
| `output_prefix` | **Type:** str<br/><br/>**Default:** 'Tick, tock, the current date/time is ' |
| `**kwargs` | **Type:** Any |
