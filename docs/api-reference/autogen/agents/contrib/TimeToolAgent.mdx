---
sidebarTitle: TimeToolAgent
title: autogen.agents.contrib.TimeToolAgent
---
<h2 id="autogen.agents.contrib.TimeToolAgent" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">TimeToolAgent</span>
</h2>

```python
TimeToolAgent(date_time_format: str = '%Y-%m-%d %H:%M:%S', **kwargs: Any)
```

    A simple agent that returns the current time using tools
    
    Use it is as a reference for creating new agents with a tool-based approach (as opposed to reply-based).<br/>This agent will call the TimeTool and return the date and time whenever it needs to reply.<br/>Initialize the TimeToolAgent.<br/>
