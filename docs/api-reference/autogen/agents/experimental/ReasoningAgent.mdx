...
title: autogen.agents.experimental.ReasoningAgent
---
<h2 id="autogen.agents.experimental.ReasoningAgent" class="doc doc-heading">
...
| `grader_llm_config` | **Type:** [LLMConfig](/docs/api-reference/autogen/llm_config/LLMConfig) \| dict[str, typing.Any] \| None<br/><br/>**Default:** None |
| `max_depth` | **Type:** int<br/><br/>**Default:** 4 |
| `beam_size` | **Type:** int<br/><br/>**Default:** 3 |
| `answer_approach` | **Type:** Literal['pool', 'best']<br/><br/>**Default:** 'pool' |
...
<br />
    ...
    Get the reasoning method being used.<br/>Returns: <br/>    str: The name of the reasoning method
...
```python
execute_node(self, node: ThinkNode) -> str | None
```

    Execute the node's content to get the response.<br/>This method runs the node's content to get the response.<br/>If the content contains a Python code snippet, it sends the code to the user proxy agent for execution.<br/>Else, it sends the content to the LLM for generating the response.<br/>

<b>Parameters:</b>
| Name | Description |
|--|--|
| `node` | The node to run.<br/><br/>**Type:** [ThinkNode](/docs/api-reference/autogen/agents/experimental/ThinkNode) |

<b>Returns:</b>
| Type | Description |
|--|--|
| str \| None | Optional[str]: The response generated by the node, or None if the node is TERMINATE. |
...
```python
extract_rlhf_preference_dataset(self, contrastive_threshold: float = 0.2) -> list[dict[str, Any]]
```
...
```python
extract_sft_dataset(self) -> list[dict[str, Any]]
```

    Extract the best trajectory or multiple equally good trajectories for SFT training.<br/>Returns: <br/>    list[dict]: list of best trajectories, each one is a pair of instruction and response.<br/>Raises: <br/>    RuntimeError: If the tree has not been generated yet.
...
| Name | Description |
|--|--|
| `messages` | Input messages to respond to<br/><br/>**Type:** list[dict[str, typing.Any]] \| None<br/><br/>**Default:** None |
| `sender` | Agent sending the messages<br/><br/>**Type:** [Agent](/docs/api-reference/autogen/Agent) \| None<br/><br/>**Default:** None |
...
```
    ...
    Rate the quality of a reasoning path or the final answer using the grader agent.<br/>

<b>Parameters:</b>
| Name | Description |
|--|--|
| `node` | Node containing the reasoning trajectory to evaluate<br/><br/>**Type:** [ThinkNode](/docs/api-reference/autogen/agents/experimental/ThinkNode) |
| `ground_truth` | Optional ground truth to provide to the grader<br/><br/>**Type:** str \| None<br/><br/>**Default:** None |
...
```
    ...
    Visualize the tree of thoughts using graphviz.<br/>Raises: <br/>    RuntimeError: If the tree has not been generated yet.
