...
DoclingDocIngestAgent(
    ...
    query_engine: DoclingMdQueryEngine | None = None,
...
| `parsed_docs_path` | **Type:** str \| pathlib.Path \| None<br/><br/>**Default:** None |
| `query_engine` | **Type:** [DoclingMdQueryEngine](/docs/api-reference/autogen/agents/experimental/document_agent/docling_query_engine/DoclingMdQueryEngine) \| None<br/><br/>**Default:** None |
