...
DoclingDocIngestAgent(
    ...
    query_engine: VectorChromaQueryEngine | InMemoryQueryEngine | None = None,
...
| `query_engine` | **Type:** [VectorChromaQueryEngine](/docs/api-reference/autogen/agents/experimental/document_agent/chroma_query_engine/VectorChromaQueryEngine) \| [InMemoryQueryEngine](/docs/api-reference/autogen/agents/experimental/document_agent/inmemory_query_engine/InMemoryQueryEngine) \| None<br/><br/>**Default:** None |
