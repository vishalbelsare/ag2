---
sidebarTitle: DoclingDocIngestAgent
title: autogen.agents.experimental.DoclingDocIngestAgent
---
<h2 id="autogen.agents.experimental.DoclingDocIngestAgent" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">DoclingDocIngestAgent</span>
</h2>
...
```
    ...
    A DoclingDocIngestAgent is a swarm agent that ingests documents using the docling_parse_docs tool.<br/>Initialize the DoclingDocIngestAgent.<br/>

<b>Parameters:</b>
| Name | Description |
|--|--|
| `name` | **Type:** str \| None<br/><br/>**Default:** None |
| `llm_config` | **Type:** [LLMConfig](/docs/api-reference/autogen/llm_config/LLMConfig) \| dict \| Literal[False] \| None<br/><br/>**Default:** None |
| `parsed_docs_path` | **Type:** pathlib.Path \| str \| None<br/><br/>**Default:** None |
| `query_engine` | **Type:** [RAGQueryEngine](/docs/api-reference/autogen/agentchat/contrib/rag/RAGQueryEngine) \| None<br/><br/>**Default:** None |
| `return_agent_success` | **Type:** str<br/><br/>**Default:** 'TaskManagerAgent' |
| `return_agent_error` | **Type:** str<br/><br/>**Default:** 'ErrorManagerAgent' |
