---
sidebarTitle: DocumentAgent
title: autogen.agents.experimental.DocumentAgent
---
<h2 id="autogen.agents.experimental.DocumentAgent" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">DocumentAgent</span>
</h2>
...
```
    ...
    The DocumentAgent is responsible for ingest and querying documents.<br/>Internally, it generates a group of swarm agents to solve tasks.<br/>Initialize the DocumentAgent.<br/>
