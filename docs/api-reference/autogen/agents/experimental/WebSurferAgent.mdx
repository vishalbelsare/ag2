...
| `web_tool_llm_config` | **Type:** [LLMConfig](/docs/api-reference/autogen/llm_config/LLMConfig) \| dict[str, typing.Any] \| None<br/><br/>**Default:** None |
| `web_tool` | **Type:** Literal['browser_use', 'crawl4ai']<br/><br/>**Default:** 'browser_use' |
| `web_tool_kwargs` | **Type:** dict[str, typing.Any] \| None<br/><br/>**Default:** None |
| `**kwargs` | **Type:** Any |
