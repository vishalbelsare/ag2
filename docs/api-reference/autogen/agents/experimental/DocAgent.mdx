...
title: autogen.agents.experimental.DocAgent
---
<h2 id="autogen.agents.experimental.DocAgent" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">DocAgent</span>
</h2>
...
```
    ...
    The DocAgent is responsible for ingest and querying documents.<br/>Internally, it generates a group of swarm agents to solve tasks.<br/>Initialize the DocAgent.<br/>
...
| Name | Description |
|--|--|
| `messages` | **Type:** list[dict[str, typing.Any]] \| str \| None<br/><br/>**Default:** None |
| `sender` | **Type:** [Agent](/docs/api-reference/autogen/Agent) \| None<br/><br/>**Default:** None |
