...
| Type | Description |
|--|--|
| `autogen.tools.tool.Tool` | Tool: The converted tool. |
...
```python
get_interoperability_class(type: str) -> type[autogen.interop.interoperable.Interoperable]
```
...
| Type | Description |
|--|--|
| `type[autogen.interop.interoperable.Interoperable]` | Type[Interoperable]: The interoperability class type. |
