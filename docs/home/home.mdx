...
<div class="homepage-hero-section">
  <div class="hero-content">
    ...
    <div class="hero-text-section">
      ...
      <a class="hero-btn" href="/docs/user-guide/quick-start">
...
<div class="explore-content">
  <div class="explore-content-grid-container">
    <CardGroup cols={2}>
      <Card title="Quick Start" href="/docs/user-guide/quick-start">
...
<div className="edit-url-container">
    <a className="edit-url" href="https://github.com/ag2ai/ag2/edit/main/website/docs/home/home.mdx" target='_blank'><Icon icon="pen" iconType="solid" size="13px"/> Edit this page</a>
</div>
