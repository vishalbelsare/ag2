...
for an
agent](https://ag2ai.github.io/ag2/docs/tutorial/conversation-patterns#nested-chats).
...
chat](https://ag2ai.github.io/ag2/docs/reference/agentchat/conversable_agent#register_nested_chats)
...
GroupChat](https://ag2ai.github.io/ag2/docs/topics/groupchat/resuming_groupchat)
