...
[`config_list_from_json`](../../docs/reference/oai/openai_utils#config_list_from_json)
...
-   Having a single global list of models and [filtering
    it](#config-list-filtering) based on certain keys (e.g. name, tag)
    in order to pass select models into a certain agent (e.g. use
...
[`filter_config`](../../docs/reference/oai/openai_utils#filter_config):
...
-   `cache_seed` - This is a legacy parameter and not recommended to be
    ...
    [Cache](../../docs/reference/cache/) object into
    [`initiate_chat`](../../docs/reference/agentchat/conversable_agent#initiate_chat).
...
-   [`get_config_list`](../../docs/reference/oai/openai_utils#get_config_list):
    Generates configurations for API calls, primarily from provided API
    keys.
-   [`config_list_openai_aoai`](../../docs/reference/oai/openai_utils#config_list_openai_aoai):
...
-   [`config_list_from_models`](../../docs/reference/oai/openai_utils#config_list_from_models):
    ...
    configuration.
-   [`config_list_from_dotenv`](../../docs/reference/oai/openai_utils#config_list_from_dotenv):
