...
title: autogen.agentchat.contrib.reasoning_agent
---
...
<a href="#autogen.agentchat.contrib.reasoning_agent..extract_rlhf_preference_dataset" class="headerlink" title="Permanent link"></a>
...
<code class="doc-symbol doc-symbol-heading doc-symbol-function"></code>
#### extract_sft_dataset
<a href="#autogen.agentchat.contrib.reasoning_agent..extract_sft_dataset" class="headerlink" title="Permanent link"></a>
...
<code class="doc-symbol doc-symbol-heading doc-symbol-function"></code>
#### visualize_tree
<a href="#autogen.agentchat.contrib.reasoning_agent..visualize_tree" class="headerlink" title="Permanent link"></a>
...
<br />
    ...
    <h2 id="autogen.agentchat.contrib.reasoning_agent.ReasoningAgent" class="doc doc-heading">
        <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
        <span class="doc doc-object-name doc-class-name">ReasoningAgent</span>
        <a href="#autogen.agentchat.contrib.reasoning_agent.ReasoningAgent" class="headerlink" title="Permanent link"></a>
    </h2>
...
#### method
<a href="#autogen.agentchat.contrib.reasoning_agent.ReasoningAgent.method" class="headerlink" title="Permanent link"></a>
...
<a href="#autogen.agentchat.contrib.reasoning_agent.ReasoningAgent.generate_forest_response" class="headerlink" title="Permanent link"></a>
...
<code class="doc-symbol doc-symbol-heading doc-symbol-method"></code>
#### rate_node
<a href="#autogen.agentchat.contrib.reasoning_agent.ReasoningAgent.rate_node" class="headerlink" title="Permanent link"></a>
...
<br />
    ...
    <h2 id="autogen.agentchat.contrib.reasoning_agent.ThinkNode" class="doc doc-heading">
        <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
        <span class="doc doc-object-name doc-class-name">ThinkNode</span>
        <a href="#autogen.agentchat.contrib.reasoning_agent.ThinkNode" class="headerlink" title="Permanent link"></a>
    </h2>
...
<code class="doc-symbol doc-symbol-heading doc-symbol-method"></code>
#### from_dict
<a href="#autogen.agentchat.contrib.reasoning_agent.ThinkNode.from_dict" class="headerlink" title="Permanent link"></a>

```python
from_dict(data: dict, parent: ForwardRef('ThinkNode') | None = None) -> autogen.agentchat.contrib.reasoning_agent.ThinkNode
```
...
| Type | Description |
|--|--|
| `autogen.agentchat.contrib.reasoning_agent.ThinkNode` | ThinkNode: Reconstructed node with all children |
...
<code class="doc-symbol doc-symbol-heading doc-symbol-attribute"></code>
#### trajectory
<a href="#autogen.agentchat.contrib.reasoning_agent.ThinkNode.trajectory" class="headerlink" title="Permanent link"></a>
...
<code class="doc-symbol doc-symbol-heading doc-symbol-method"></code>
#### backpropagate
<a href="#autogen.agentchat.contrib.reasoning_agent.ThinkNode.backpropagate" class="headerlink" title="Permanent link"></a>
...
<code class="doc-symbol doc-symbol-heading doc-symbol-method"></code>
#### to_dict
<a href="#autogen.agentchat.contrib.reasoning_agent.ThinkNode.to_dict" class="headerlink" title="Permanent link"></a>
