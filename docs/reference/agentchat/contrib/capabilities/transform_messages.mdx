---
sidebarTitle: transform_messages
title: autogen.agentchat.contrib.capabilities.transform_messages
---
    ...
    <h2 id="autogen.agentchat.contrib.capabilities.transform_messages.TransformMessages" class="doc doc-heading">
        ...
        <a href="#autogen.agentchat.contrib.capabilities.transform_messages.TransformMessages" class="headerlink" title="Permanent link"></a>
    </h2>
...
#### add_to_agent
<a href="#autogen.agentchat.contrib.capabilities.transform_messages.TransformMessages.add_to_agent" class="headerlink" title="Permanent link"></a>
