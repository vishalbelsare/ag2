...
**NOTE: To integrate this setup into GroupChat, follow the [tutorial](https://docs.ag2.ai/notebooks/agentchat_groupchat) with the same config as above.**
...
For an interesting chess game between Anthropic's Sonnet and Mistral's Mixtral, we've put together a sample notebook that highlights some of the tips and tricks for working with non-OpenAI LLMs. [See the notebook here](https://docs.ag2.ai/notebooks/agentchat_nested_chats_chess_altmodels).
