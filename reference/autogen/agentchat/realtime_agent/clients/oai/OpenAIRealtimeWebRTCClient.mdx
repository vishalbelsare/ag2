...
title: autogen.agentchat.realtime_agent.clients.oai.OpenAIRealtimeWebRTCClient
---
<h2 id="autogen.agentchat.realtime_agent.clients.oai.OpenAIRealtimeWebRTCClient" class="doc doc-heading">
    <code class="doc-symbol doc-symbol-heading doc-symbol-class"></code>
    <span class="doc doc-object-name doc-class-name">OpenAIRealtimeWebRTCClient</span>
    <a href="#autogen.agentchat.realtime_agent.clients.oai.OpenAIRealtimeWebRTCClient" class="headerlink" title="Permanent link"></a>
</h2>
...
#### get_factory
<a href="#autogen.agentchat.realtime_agent.clients.oai.OpenAIRealtimeWebRTCClient.get_factory" class="headerlink" title="Permanent link"></a>
...
get_factory(
    ...
    **kwargs: Any
) -> Callable[[], autogen.agentchat.realtime_agent.clients.RealtimeClientProtocol] | None
```
...
| Type | Description |
|--|--|
| `Callable[[], autogen.agentchat.realtime_agent.clients.RealtimeClientProtocol] \| None` | RealtimeClientProtocol: The Realtime API client is returned if the model matches the pattern |
...
#### logger
<a href="#autogen.agentchat.realtime_agent.clients.oai.OpenAIRealtimeWebRTCClient.logger" class="headerlink" title="Permanent link"></a>
...
<code class="doc-symbol doc-symbol-heading doc-symbol-method"></code>
#### connect
<a href="#autogen.agentchat.realtime_agent.clients.oai.OpenAIRealtimeWebRTCClient.connect" class="headerlink" title="Permanent link"></a>
...
<code class="doc-symbol doc-symbol-heading doc-symbol-method"></code>
#### read_events
<a href="#autogen.agentchat.realtime_agent.clients.oai.OpenAIRealtimeWebRTCClient.read_events" class="headerlink" title="Permanent link"></a>
...
<code class="doc-symbol doc-symbol-heading doc-symbol-method"></code>
#### send_audio
<a href="#autogen.agentchat.realtime_agent.clients.oai.OpenAIRealtimeWebRTCClient.send_audio" class="headerlink" title="Permanent link"></a>
...
<a href="#autogen.agentchat.realtime_agent.clients.oai.OpenAIRealtimeWebRTCClient.send_function_result" class="headerlink" title="Permanent link"></a>
...
<code class="doc-symbol doc-symbol-heading doc-symbol-method"></code>
#### send_text
<a href="#autogen.agentchat.realtime_agent.clients.oai.OpenAIRealtimeWebRTCClient.send_text" class="headerlink" title="Permanent link"></a>
...
<code class="doc-symbol doc-symbol-heading doc-symbol-method"></code>
#### session_init_data
<a href="#autogen.agentchat.realtime_agent.clients.oai.OpenAIRealtimeWebRTCClient.session_init_data" class="headerlink" title="Permanent link"></a>
...
<code class="doc-symbol doc-symbol-heading doc-symbol-method"></code>
#### session_update
<a href="#autogen.agentchat.realtime_agent.clients.oai.OpenAIRealtimeWebRTCClient.session_update" class="headerlink" title="Permanent link"></a>
...
<code class="doc-symbol doc-symbol-heading doc-symbol-method"></code>
#### truncate_audio
<a href="#autogen.agentchat.realtime_agent.clients.oai.OpenAIRealtimeWebRTCClient.truncate_audio" class="headerlink" title="Permanent link"></a>
