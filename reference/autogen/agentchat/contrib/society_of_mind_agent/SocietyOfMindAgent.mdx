...
| `chat_manager` | **Type:** `autogen.GroupChatManager` |
...
```python
update_chat_manager(self, chat_manager: autogen.GroupChatManager | None) -> 
```
...
| Name | Description |
|--|--|
| `chat_manager` | the group chat manager<br/><br/>**Type:** `autogen.GroupChatManager \| None` |
