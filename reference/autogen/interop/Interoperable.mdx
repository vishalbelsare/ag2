...
<h2 id="autogen.interop.Interoperable" class="doc doc-heading">
    ...
    <a href="#autogen.interop.Interoperable" class="headerlink" title="Permanent link"></a>
</h2>
...
#### convert_tool
<a href="#autogen.interop.Interoperable.convert_tool" class="headerlink" title="Permanent link"></a>
...
| Type | Description |
|--|--|
| `autogen.tools.Tool` | Tool: The converted tool in the desired format or type. |

<br />

<code class="doc-symbol doc-symbol-heading doc-symbol-method"></code>
#### get_unsupported_reason
<a href="#autogen.interop.Interoperable.get_unsupported_reason" class="headerlink" title="Permanent link"></a>
